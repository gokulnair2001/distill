/* @ts-self-types="./distill_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function distill_html(html) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.distill_html(retptr, ptr0, len0);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('distill_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
